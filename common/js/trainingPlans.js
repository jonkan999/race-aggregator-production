...
const translations = {
  plan_variation: {
    focus_label: '{{ training_plans.plan_variation.focus_label }}',
    weekly_structure_label:
      '{{ training_plans.plan_variation.weekly_structure_label }}',
    distribution_label:
      '{{ training_plans.plan_variation.distribution_label }}',
    sessions_per_week: '{{ training_plans.plan_variation.sessions_per_week }}',
    select_button: '{{ training_plans.plan_variation.select_button }}',
  },
  messages: {
    week_label: '{{ training_plans.messages.week_label }}',
    weeks: '{{ training_plans.messages.weeks }}',
    hilly_terrain_note: '{{ training_plans.messages.hilly_terrain_note }}',
  },
  errors: {
    required_fields: '{{ training_plans.errors.required_fields }}',
    no_matching_plan: '{{ training_plans.errors.no_matching_plan }}',
    no_matching_variations:
      '{{ training_plans.errors.no_matching_variations }}',
    invalid_training_days: '{{ training_plans.errors.invalid_training_days }}',
    loading_plans: '{{ training_plans.errors.loading_plans }}',
  },
  workout_components: {
    warmup_label: '{{ training_plans.workout_components.warmup_label }}',
    main_workout_label:
      '{{ training_plans.workout_components.main_workout_label }}',
    cooldown_label: '{{ training_plans.workout_components.cooldown_label }}',
    intensity_label: '{{ training_plans.workout_components.intensity_label }}',
    duration_label: '{{ training_plans.workout_components.duration_label }}',
  },
  weekdays: {
    monday: '{{ training_plans.weekdays.monday }}',
    tuesday: '{{ training_plans.weekdays.tuesday }}',
    wednesday: '{{ training_plans.weekdays.wednesday }}',
    thursday: '{{ training_plans.weekdays.thursday }}',
    friday: '{{ training_plans.weekdays.friday }}',
    saturday: '{{ training_plans.weekdays.saturday }}',
    sunday: '{{ training_plans.weekdays.sunday }}',
  },
};

// Training types with translations
const trainingTypes = {
  easy: '{{ training_plans.workout_types.easy }}',
  tempo: '{{ training_plans.workout_types.tempo }}',
  intervals: '{{ training_plans.workout_types.intervals }}',
  long: '{{ training_plans.workout_types.long }}',
  rest: '{{ training_plans.workout_types.rest }}',
};

// Add workout type translations
const workoutTypes = {
  recovery: '{{ training_plans.workout_types.recovery }}',
  easy: '{{ training_plans.workout_types.easy }}',
  tempo: '{{ training_plans.workout_types.tempo }}',
  intervals: '{{ training_plans.workout_types.intervals }}',
  long: '{{ training_plans.workout_types.long }}',
...
async function loadTrainingPlans() {
  try {
    const response = await fetch(
      `/json/training_plans_{{ country_code }}.json`
    );
