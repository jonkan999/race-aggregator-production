...
async function initializeWhenReady() {
  ...
  const distanceMapping = {"10,4km": ["Millopp", "10 km"], "10,5km": ["Millopp", "10 km"], "10,7km": ["Millopp", "10 km"], "100km": ["50 miles", "100 km"], "10km": ["Millopp", "10 km", "10000 meter"], "11km": ["Millopp", "10 km"], "20km": ["Halvmarathon"], "3km": ["3000 meter"], "4km": ["5 km"], "5,3km": ["5 km"], "5,4km": ["5 km"], "50km": ["50 km"], "5km": ["5 km", "5000 meter"], "6km": ["5 km"]};
  ...
  const dateRangeFrom = " alates";
  const dateRangeTo = " kuni";
  ...
  const defaultRegionText = "Eesti";
  const defaultCountyText = "Kõik maakonnad";

  const country_code = "ee";
  const language_code = "et";

  const categoryMapping = {"10 km": {"range": [9, 11]}, "100 km": {"range": [90, 110]}, "100 miles": {"range": [150, 170]}, "10000 meter": {"range": [10, 10]}, "1500 meter": {"range": [1.5, 1.5]}, "200 miles": {"range": [300, 500]}, "3000 meter": {"range": [3, 3]}, "5 km": {"range": [4, 6]}, "50 km": {"range": [45, 55]}, "50 miles": {"range": [75, 100]}, "5000 meter": {"range": [5, 5]}, "Backyard Ultra": "tagahoov", "Halvmarathon": {"range": [20, 22]}, "Marathon": {"range": [40, 44]}, "Millopp": {"range": [9, 11]}};
  ...
  function checkFilters() {
    ...
    if (filtersChanged) {
      ...
      const redirectUrl = `/jooksuvoistlused/?category=${encodeURIComponent(currentFilters.category)}&county=${encodeURIComponent(currentFilters.county)}&race_type=${encodeURIComponent(currentFilters.race_type)}`;
