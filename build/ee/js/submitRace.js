...
const messages = {
  auth: {
    titleNewUser: 'Loo konto',
    titleSignIn: 'Logi sisse',
    passwordPlaceholder: 'Salasõna',
    submitNewUser: 'Loo konto',
    submitSignIn: 'Logi sisse',
    forgotPassword: 'Unustasid parooli?',
    errorWrongPassword: 'Vale parool',
  },
  submission: {
    loggedInAs: 'Sisse logitud kui korraldaja',
    submittingNewRace: 'saadan sisse uue võistluse',
    newAccountCreated: 'Selleks, et jooksu saaks hallata, pead kinnitama oma e-posti aadressi. Kinnituslink on saadetud antud e-posti aadressile.',
    passwordResetSent: 'Parooli taastamise teade saadetud. Kontrolli oma postkasti.',
    unexpectedError: 'Ilmnes viga. Proovige uuesti.',
    processingSubmission: 'Töötan esitamise kallal...',
    raceExists: 'Võistlus on juba andmebaasis olemas.',
    raceSubmitted: 'Võistlus on esitatud!',
    submissionFailed: 'Kliendil ei õnnestunud jooksu esitada. Proovige uuesti.',
    missingFields: 'Puudub midagi. Veenduge, et kõik kohustuslikud väljad on täidetud ja et kaardilt on valitud koht.',
  },
};
...
async function processSubmission(db, userId) {
  ...
  const racesRef = collection(db, 'submissions_ee');
  const q = query(
    racesRef,
