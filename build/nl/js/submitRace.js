...
const messages = {
  auth: {
    titleNewUser: 'Maak account',
    titleSignIn: 'Inloggen',
    passwordPlaceholder: 'Wachtwoord',
    submitNewUser: 'Maak account aan',
    submitSignIn: 'Inloggen',
    forgotPassword: 'Vergeten wachtwoord?',
    errorWrongPassword: 'Ongeldig wachtwoord',
  },
  submission: {
    loggedInAs: 'Ingelogd als organisator',
    submittingNewRace: 'verzendt nieuwe race',
    newAccountCreated: 'Om de race kan worden beheerd, moet je je e-mailadres bevestigen. Een bevestigingslink is verzonden naar het opgegeven e-mailadres.',
    passwordResetSent: 'Wachtwoordherstel verzonden. Controleer je inbox.',
    unexpectedError: 'Er is een fout opgetreden. Probeer het opnieuw.',
    processingSubmission: 'Verwerken van inzending...',
    raceExists: 'De race bestaat al in de database.',
    raceSubmitted: 'De race is ingediend!',
    submissionFailed: 'Kon kon het evenement niet indienen. Probeer het opnieuw.',
    missingFields: 'Er ontbreekt iets. Zorg ervoor dat alle verplichte velden zijn ingevuld en dat er een locatie op de kaart is geselecteerd.',
  },
};
