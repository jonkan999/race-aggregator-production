...
const messages = {
  auth: {
    titleNewUser: 'Konto erstellen',
    titleSignIn: 'Anmelden',
    passwordPlaceholder: 'Passwort',
    submitNewUser: 'Konto erstellen',
    submitSignIn: 'Anmelden',
    forgotPassword: 'Hast du dein Passwort vergessen?',
    errorWrongPassword: 'Falsches Passwort',
  },
  submission: {
    loggedInAs: 'Eingeloggt als Veranstalter',
    submittingNewRace: 'neues Rennen einreichen',
    newAccountCreated: 'Um das Rennen verwalten zu können, müssen Sie Ihre E-Mail-Adresse bestätigen. Ein Bestätigungslink wurde an die angegebene E-Mail-Adresse gesendet.',
    ...
    processingSubmission: 'Verarbeite Einreichung...',
    raceExists: 'Das Rennen existiert bereits in der Datenbank.',
    raceSubmitted: 'Das Rennen wurde eingereicht!',
    submissionFailed: 'Konnte das Rennen nicht einreichen. Bitte versuchen Sie es erneut.',
    missingFields: 'Etwas fehlt. Stellen Sie sicher, dass alle Pflichtfelder ausgefüllt sind und dass ein Ort auf der Karte ausgewählt wurde.',
  },
};
...
async function processSubmission(db, userId) {
  ...
  const racesRef = collection(db, 'submissions_de');
  const q = query(
    racesRef,
