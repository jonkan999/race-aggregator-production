  ...
  (entries) => {
    entries.forEach((entry) => {
      if (entry.isIntersecting) {
        ...
        // Only handle unpacking if not already unpacked
        if (entry.target.classList.contains('packed')) {
          unpackRaceCard(entry.target);
        }
...
// Start observing cards when DOM is ready
document.addEventListener('DOMContentLoaded', () => {
  const cards = document.querySelectorAll('.race-card:not(.filtered-out):not(.race-card-big)');
  cards.forEach(card => {
...
async function initializeWhenReady() {
  ...
  const distanceMapping = {"1,5km": ["1500 meter"], "10,2km": ["10 km", "Millopp"], "10,3km": ["10 km", "Millopp"], "10,4km": ["10 km", "Millopp"], "10,5km": ["10 km", "Millopp"], "10,6km": ["10 km", "Millopp"], "10,8km": ["10 km", "Millopp"], "10,9km": ["10 km", "Millopp"], "100km": ["100 km", "50 miles"], "10km": ["10000 meter", "10 km", "Millopp"], "11km": ["10 km", "Millopp"], "20,1km": ["Halvmarathon"], "20km": ["Halvmarathon"], "22km": ["Halvmarathon"], "3km": ["3000 meter"], "4,1km": ["5 km"], "4,2km": ["5 km"], "4,3km": ["5 km"], "4,4km": ["5 km"], "4,5km": ["5 km"], "4,6km": ["5 km"], "4,7km": ["5 km"], "4,8km": ["5 km"], "4,9km": ["5 km"], "40km": ["Marathon"], "47km": ["50 km"], "4km": ["5 km"], "5,0km": ["5 km", "5000 meter"], "5,1km": ["5 km"], "5,2km": ["5 km"], "5,3km": ["5 km"], "5,4km": ["5 km"], "5,5km": ["5 km"], "5,6km": ["5 km"], "5,7km": ["5 km"], "5,8km": ["5 km"], "5,9km": ["5 km"], "50km": ["50 km"], "54km": ["50 km"], "55km": ["50 km"], "5km": ["5 km", "5000 meter"], "6,0km": ["5 km"], "6km": ["5 km"], "9,1km": ["10 km", "Millopp"], "9,2km": ["10 km", "Millopp"], "9,3km": ["10 km", "Millopp"], "9,5km": ["10 km", "Millopp"], "9,6km": ["10 km", "Millopp"], "9,7km": ["10 km", "Millopp"], "9,8km": ["10 km", "Millopp"], "9,9km": ["10 km", "Millopp"], "9km": ["10 km", "Millopp"], "marathon": ["Marathon"]};
  ...
  const dateRangeFrom = " von";
  const dateRangeTo = " bis";
  ...
  const defaultRegionText = "Deutschland";
  const defaultCountyText = "Alle Bundesländer";

  const country_code = "de";
  const language_code = "de";

  const categoryMapping = {"10 km": {"range": [9, 11]}, "100 km": {"range": [90, 110]}, "100 miles": {"range": [150, 170]}, "10000 meter": {"range": [10, 10]}, "1500 meter": {"range": [1.5, 1.5]}, "200 miles": {"range": [300, 500]}, "3000 meter": {"range": [3, 3]}, "5 km": {"range": [4, 6]}, "50 km": {"range": [45, 55]}, "50 miles": {"range": [75, 100]}, "5000 meter": {"range": [5, 5]}, "Backyard Ultra": "Hinterhof", "Halvmarathon": {"range": [20, 22]}, "Marathon": {"range": [40, 44]}, "Millopp": {"range": [9, 11]}};
  ...
  function checkFilters() {
    ...
    if (filtersChanged) {
      ...
      const redirectUrl = `/laufkalender/?category=${encodeURIComponent(currentFilters.category)}&county=${encodeURIComponent(currentFilters.county)}&race_type=${encodeURIComponent(currentFilters.race_type)}`;
  ...
  function updateEventRange() {
    ...
    eventRange.textContent = `${start}-${end} von ${filteredCards.length} `;
  }
