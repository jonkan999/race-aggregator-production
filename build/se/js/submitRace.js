...
const messages = {
  ...
  submission: {
    ...
    submittingNewRace: 'skickar in nytt lopp',
    newAccountCreated: 'För att loppet ska kunna hanteras måste du bekräfta din e-postadress. En länk till bekräftelse har skickats till den angivna e-postadressen.',
    passwordResetSent: 'Lösenordsåterställning skickad. Kolla din inkorg.',
    unexpectedError: 'Ett fel uppstod. Försök igen.',
    processingSubmission: 'Bearbetar inskickning...',
    raceExists: 'Loppet finns redan i databasen.',
    raceSubmitted: 'Loppet har skickats in!',
    submissionFailed: 'Kunde inte skicka in loppet. Försök igen.',
    missingFields: 'Något saknas. Se till att alla obligatoriska fält är ifyllda och att en plats har valts på kartan.',
  },
};
