document.addEventListener("DOMContentLoaded", function () {
  const distanceMapping = {"1,5km": ["1500 meter"], "10,5km": ["Millopp", "10 km"], "100 miles": ["100 miles"], "100km": ["100 km", "50 miles"], "10km": ["Millopp", "10 km", "10000 meter"], "11km": ["Millopp", "10 km"], "20km": ["Halvmarathon"], "22km": ["Halvmarathon"], "321,9km": ["200 miles"], "3km": ["3000 meter"], "4,3km": ["5 km"], "4,8km": ["5 km"], "40km": ["Marathon"], "44km": ["Marathon"], "45km": ["50 km"], "46km": ["50 km"], "47km": ["50 km"], "4km": ["5 km"], "5,5km": ["5 km"], "5,6km": ["5 km"], "50 miles": ["50 miles"], "50km": ["50 km"], "5km": ["5000 meter", "5 km"], "6km": ["5 km"], "75km": ["50 miles"], "77km": ["50 miles"], "84km": ["50 miles"], "90km": ["100 km", "50 miles"], "96km": ["100 km", "50 miles"], "9km": ["Millopp", "10 km"], "half marathon": ["Halvmarathon"], "marathon": ["Marathon"]};
  ...
  function insertAds() {
    ...
    // Create a single observer for all ads
    const observer = window.ResizeObserver ? new ResizeObserver(entries => {
        entries.forEach(entry => initializeAd(entry.target));
    }) : null;
      ...
      if ((index + 1) % 3 === 0) {
        ...
        wrappers.forEach(wrapper => {
          if (observer) {
            ...
            // Single timeout for older browsers
            setTimeout(() => initializeAd(wrapper), 100);
          }
        });
      }
    });

    function initializeAd(wrapper, retryCount = 0) {
    ...
    // Cleanup observer when page changes
    return () => {
        if (observer) {
            observer.disconnect();
        }
