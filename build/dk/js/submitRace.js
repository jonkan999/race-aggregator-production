...
const messages = {
  auth: {
    titleNewUser: 'Opret konto',
    titleSignIn: 'Log ind',
    passwordPlaceholder: 'Adgangskode',
    submitNewUser: 'Opret konto',
    submitSignIn: 'Log ind',
    forgotPassword: 'Glemt adgangskode?',
    errorWrongPassword: 'Forkert adgangskode',
  },
  submission: {
    loggedInAs: 'Inlogget som arrangør',
    submittingNewRace: 'indsender nyt løb',
    newAccountCreated: 'For at løbet kan blive håndteret, skal du bekræfte din e-mailadresse. Et link til bekræftelse er sendt til den angivne e-mailadresse.',
    passwordResetSent: 'Passwordnulstilling sendt. Tjek din indbakke.',
    unexpectedError: 'Der opstod en fejl. Prøv igen.',
    processingSubmission: 'Behandler indsendelse...',
    raceExists: 'Løbet findes allerede i databasen.',
    raceSubmitted: 'Løbet er blevet indsendt!',
    submissionFailed: 'Kunne ikke indsende løbet. Prøv igen.',
    missingFields: 'Noget mangler. Sørg for, at alle obligatoriske felter er udfyldt, og at et sted er valgt på kortet.',
  },
};
...
async function processSubmission(db, userId) {
  ...
  const racesRef = collection(db, 'submissions_dk');
  const q = query(
    racesRef,
