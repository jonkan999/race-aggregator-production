document.addEventListener("DOMContentLoaded", function () {
  ...
  function checkFilters() {
    ...
    if (filtersChanged) {
      ...
      const redirectUrl = `/terminliste.html?category=${encodeURIComponent(currentFilters.category)}&county=${encodeURIComponent(currentFilters.county)}&race_type=${encodeURIComponent(currentFilters.race_type)}`;
