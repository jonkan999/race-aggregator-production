...
const messages = {
  auth: {
    titleNewUser: 'Luo tili',
    titleSignIn: 'Kirjaudu sisään',
    passwordPlaceholder: 'Salasana',
    submitNewUser: 'Luo tili',
    submitSignIn: 'Kirjaudu sisään',
    forgotPassword: 'Unohditko salasanan?',
    errorWrongPassword: 'Virheellinen salasana',
  },
  submission: {
    loggedInAs: 'Sisäänkirjautuneena järjestäjänä',
    submittingNewRace: 'lähettää uutta kilpailua',
    newAccountCreated: 'Jotta kilpailu voidaan käsitellä, sinun on vahvistettava sähköpostiosoitteesi. Vahvistuslinkki on lähetetty annettuun sähköpostiosoitteeseen.',
    passwordResetSent: 'Salasanan palautus lähetetty. Tarkista saapuneet.',
    unexpectedError: 'Tapahtui virhe. Yritä uudelleen.',
    processingSubmission: 'Käsitellään lähetystä...',
    raceExists: 'Kilpailu on jo olemassa tietokannassa.',
    raceSubmitted: 'Kilpailu on lähetetty!',
    submissionFailed: 'Lähetystä ei voitu lähettää. Yritä uudelleen.',
    missingFields: 'Jotain puuttuu. Varmista, että kaikki pakolliset kentät on täytetty ja että kartalta on valittu paikka.',
  },
};
...
async function processSubmission(db, userId) {
  ...
  const racesRef = collection(db, 'submissions_fi');
  const q = query(
    racesRef,
