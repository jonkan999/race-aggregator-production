...
async function initializeWhenReady() {
  ...
  const distanceMapping = {"1,5km": ["1500 meter"], "10,3km": ["10 km"], "10,5km": ["10 km"], "10,6km": ["10 km"], "100km": ["100 km", "50 miles"], "108km": ["100 km"], "10km": ["10 km", "10000 meter"], "20km": ["Halvmarathon"], "3km": ["3000 meter"], "4,5km": ["5 km"], "4,6km": ["5 km"], "4,8km": ["5 km"], "40km": ["Marathon"], "4km": ["5 km"], "5,5km": ["5 km"], "5,8km": ["5 km"], "50km": ["50 km"], "52km": ["50 km"], "54km": ["50 km"], "5km": ["5000 meter", "5 km"], "6km": ["5 km"], "9km": ["10 km"]};
  ...
  const dateRangeFrom = " alkaen";
  const dateRangeTo = " -";
  const dateRangeSingle = " None";
  ...
  function checkFilters() {
    ...
    if (filtersChanged) {
      ...
      const redirectUrl = `/juoksukalenteri/?category=${encodeURIComponent(currentFilters.category)}&county=${encodeURIComponent(currentFilters.county)}&race_type=${encodeURIComponent(currentFilters.race_type)}`;
  ...
  function updateEventRange() {
    ...
    eventRange.textContent = `${start}-${end} / ${filteredCards.length} `;
  }
